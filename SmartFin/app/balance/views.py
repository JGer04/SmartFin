...
def calcular_analisis(request):
    ...
    if request.method == 'POST':
        ...
        if not (empresa1_id and empresa2_id and balance1_id and balance2_id):
            ...
            try:
                ...
                return render(request, 'balance/calcular.html', {
                    'empresas': empresas,
                    'balances': balances,
                    'analisis': analisis
                })
            ...
            if not cuentas_balance1 or not cuentas_balance2:
                ...
                for cuenta1 in cuentas_balance1:
                    ...
                    # Análisis vertical
                    vertical_empresa1 = (cuenta1.monto / total_balance1 * 100) if total_balance1 else 0
                    vertical_empresa2 = (cuenta2.monto / total_balance2 * 100) if total_balance2 else 0
    ...
    # Renderizar el template con los resultados o con el formulario
    return render(request, 'balance/calcular.html', {
        'empresas': empresas,
        'balances': balances,
        'analisis': analisis,
